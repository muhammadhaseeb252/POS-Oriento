...
if (isset($_GET["sale_ret_id"])) {
    $sale_ret_id = $_GET["sale_ret_id"];

    $up_query = $con->prepare("SELECT * FROM sale_return LEFT JOIN customers ON sale_return.cust_id=customers.customer_id RIGHT JOIN sale ON sale_return.sale_id=sale.sale_id WHERE sale_return_id=:sale_return_id");
    $up_query->execute([
...
<div class="content-wrapper" style="padding-top:10px;">
    ...
    <section class="content-header">
        <h1>
            Sale Return
            <small>Update Sale Return</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Update Sale Return</li>
        </ol>
    </section>
                        ...
                        <div class="box-body" style="padding-top:15px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="<?php echo $pur_data["sale_id"]; ?>" name="sale_id">
                                    <input type="hidden" value="<?php echo $sale_ret_id; ?>" name="sale_ret_id">
                                </div><!-- /.form-group -->
                            </div><!-- /.col -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="<?php echo $pur_data["ret_date"]; ?>" class="form-control pull-right" style="width:80%;" name="ret_date">
                                </div><!-- /.form-group -->
                            </div><!-- /.col -->
                            <div class="col-md-12" style="">
                                <table class="table text-center" id="pur_table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $upd_query = $con->prepare("SELECT * FROM all_stock LEFT jOIN products ON all_stock.product_id=products.pro_id WHERE sale_ret_id=:sale_ret_id");
                                        $upd_query->execute([
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="qty[]" id="qty"
                                                        value="<?php echo ($rows["stock_in_qty"]); ?>">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="total[]" id="total"
                                                        value="<?php echo ($rows["total_sale_ret_price"]); ?>" readonly>
                                                    <input type="hidden" class="form-control" name="tot[]" id="tot"
                                                        value="<?php echo ($rows["total_sale_ret_price"]); ?>">
                                                </td>
                            ...
                            <div class="col-md-12" style="padding-bottom:20px;">
                                ...
                                <textarea name="detail" id="detail" cols="" rows="" class="pull-right form-control"
                                    style="width:91%;"><?php echo $pur_data["ret_detail"] ?></textarea>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ded in Percent"
                                            id="ded_percent" name="ded_percent" value="<?php echo $pur_data["ded_per"] ?>">
                                    </div><!-- /.input group -->
                                </div><!-- /.form group -->
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", "#save_invoice_btn", function (e) {
            ...
            form_data.append("action", "update_return_invoice");
            ...
            $.ajax({
                ...
                success: function (invoice) {
                    ...
                    if ($.trim(invoice) === 'return_updated') {
                        Swal.fire({
                            title: "Success!",
                            text: "Sale Return Invoice updated Successfully!",
                            type: "success",

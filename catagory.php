...
<!-- Jquery Insert catagory Form Validation -->
<script>
...
<!-- Jquery update catagory Form Validation -->
<script>
  $(document).ready(function () {
...
<script>
    $(document).ready(function () {
        ...
        $("#addunit_btn").click(function (e) {
            ...
            $.ajax({
                url: 'includes/catagory_module.php',
                method: 'post',
                data: form_data,
                contentType: false,
                processData: false,
                success: function (response) {
                    ...
                    if ($.trim(response) === 'inserted') {
                        toastr.success("Catagory has been created successfully!", "Successful!");
                        $("#unit_Form")[0].reset();

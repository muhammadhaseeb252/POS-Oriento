...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Sale Return
            <small>Manage Sale Return</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-aqua" style="padding-bottom:10px;padding-top:10px;">
                        ...
                        <h4 class="modal-title" style="">Sale Invoice Detail:</h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="page-header text-primary">
                                    <i class="fa fa-shopping-cart"></i> Sale Invoice.
                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive" style="">
                                    <table class="table text-center" style="width: 90%;margin:auto;">
                                        ...
                                        <tr>
                                            <th class="text-primary">Dis %:</th>
                                            <td id="tax_p">0</td>
                                            <th class="text-primary">Paid Amount:</th>
                                            <td id="paid_am">0</td>
                                        </tr>
                                        <tr>
                                            <th class="text-primary">Dis Amount:</th>
                                            <td id="tax_a">0</td>
...
<!-- Get sale data Ajax request -->
<script>
    $(document).ready(function () {

        load_sale_return();
        function load_sale_return() {
            var salereturn = "";

            $.ajax({
                url: "includes/sale_module.php",
                type: "POST",
                data: { return: salereturn },
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function (del) {
                            ...
                            if ($.trim(del) === 'deleted') {
                                toastr.warning('Sale Return Has Been Deleted Seccussfully!', 'Successfull!');

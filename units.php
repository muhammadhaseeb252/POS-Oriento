            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-aqua">
                        ...
                        <h4 class="modal-title">Insert New Unit:</h4>
                    </div>
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <select class="form-control textbox" name="unit" id="unit">
                                            ...
                                            <label class="textboxlabel">Unit:</label>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        ...
                        <form class="form-horizontal" id="update_unit_Form" autocomplete="off">
                            <div class="box-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <select class="form-control textbox" name="up_unit" id="up_unit" required>
                                                <option value="KGs">KGs</option>
                                                <option value="Grms">Grms</option>
                                                <option value="Pcs">Pcs</option>
                                                <option value="Ltrs">Ltrs</option>
    ...
    $(document).ready(function () {
        ...
        $("#addunit_btn").click(function (e) {
            ...
            if($("#unit_Form").valid()){
                ...
                form_data.append("action", "insert_unit");

                $.ajax({
                    url: 'includes/units_module.php',
                    method: 'post',
                    data: form_data,
                    contentType: false,
                    processData: false,
                    success: function (response) {
                        ...
                        if ($.trim(response) === 'inserted') {
                            toastr.success("Unit has been created successfully!", "Successful!");
                            $("#unit_Form")[0].reset();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#unittable").dataTable({
                        ...
                        buttons: [
                            {
                                text: '<i class="ion ion-person-add"></i>&nbsp; Add Unit',
        ...
        $("#update_unit_btn").click(function (e) {
            e.preventDefault();
                ...
                $.ajax({
                    url: 'includes/units_module.php',
                    method: 'post',
                    data: $("#update_unit_Form").serialize() + "&action=update_unit",
                    success: function (response) {
                        // console.log(response);

                        if ($.trim(response) === 'updated') {
                            toastr.info("Unit has been updated successfully!", "Successful!");
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if ($.trim(data) === 'deleted') {
                                toastr.warning('Unit Has Been Deleted Seccussfully!', 'Successfull!');
                                // call function here to refresh page
                                load_unit();

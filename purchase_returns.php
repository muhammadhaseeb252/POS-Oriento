...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Purchase Returns
            <small>Manage Purchase Returns</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive" style="">
                                    <table class="table text-center" style="width: 90%;margin:auto;">
                                        ...
                                        <tr>
                                            <th class="text-primary">Ded %:</th>
                                            <td id="tax_p">0</td>
                                            <th class="text-primary">Paid Amount:</th>
                                            <td id="paid_am">0</td>
                                        </tr>
                                        <tr>
                                            <th class="text-primary">Ded Amount:</th>
                                            <td id="tax_a">0</td>
...
<!-- Get purchase return data Ajax request -->
<script>
    $(document).ready(function () {

        load_purchase_return();
        function load_purchase_return() {
            var loadreturn = "";

            $.ajax({
                url: "includes/purchase_module.php",
                type: "POST",
                data: { return: loadreturn },
        ...
        // Delete purchase return AJAX request
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function (del) {
                            ...
                            if ($.trim(del) === 'deleted') {
                            toastr.warning('Purchase Return Has Been Deleted Seccussfully!', 'Successfull!');
...
<!-- Get all purchase return detail AJAX request -->
<script>
    $(document).ready(function () {

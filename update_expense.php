...
///==== get data for Update expense module====///
if(isset($_GET["expense_id"])){
    $expense_id = $_GET["expense_id"];

    $up_query = $con->prepare("SELECT * FROM expense WHERE expense_id=:expense_id");
    $up_query->execute([
    ...
    $pur_data["expense_date"] = $row["expense_date"];
    $pur_data["exp_detail"] = $row["exp_detail"];
                        ...
                        <div class="box-body" style="padding-top:15px;">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="<?php echo $pur_data["expense_date"]; ?>"
                                    class="form-control pull-right" style="width:80%;" name="up_date">
                                    <input type="hidden" name="exp_id" value="<?php echo $expense_id; ?>">
                                </div><!-- /.form-group -->
                            </div><!-- /.col -->
                            <div class="col-md-12" style="">
                                <table class="table text-center" id="pur_table">
                                    ...
                                    <tbody>
                                        <?php
                                            $upd_query = $con->prepare("SELECT * FROM expense_detail LEFT JOIN expense_cat ON expense_detail.exp_cat_id=expense_cat.expense_cat_id WHERE exp_id=:exp_id");
                                            $upd_query->execute([
                                                "exp_id"=>$expense_id
                                            ]);
                                        ...
                                        <tr>
                                            <td><?php echo $num?>
                                                <input type="hidden" id="id" name="id[]" value="<?php echo ($rows["exp_cat_id"]); ?>">
                                            </td>
                                            <td style="width:35%;">
                                                <input type="text" class="form-control" id="name" value="<?php echo ($rows["expense_cat_name"]); ?>" readonly>
                                            </td>
                                            <td style="width:30%;">
                                                <input type="date" class="form-control" value="<?php echo ($rows["date"]); ?>" name="date[]" id="date">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="total[]" id="total" value="<?php echo ($rows["total"]); ?>">
                                            </td>
                            ...
                            <div class="col-md-12" style="padding-bottom:20px;">
                                ...
                                <textarea name="detail" id="detail" class="pull-right form-control"
                                    style="width:91%;"><?php echo $pur_data["exp_detail"]; ?></textarea>
                            </div>
            ...
            if ($("#pur_table > tbody > tr").length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (invoice) {
                        console.log(invoice);
                        if ($.trim(invoice) === 'expense_updated') {
                            Swal.fire({
                                title: "Success!",
                                ...
                                window.location = 'allexpense.php';
                            });
                        }
                        else if ($.trim(invoice) === 'expense_not_updated') {
                            Swal.fire({
                                title: "Error!",
                                text: "Update Expense Error!",
                                type: "error",
                                customClass: "sweet-alert",
                            });
                        } else {

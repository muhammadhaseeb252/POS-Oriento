...
<div class="content-wrapper" style="padding-top:10px">
  ...
  <section class="content-header">
    <h1>
      Supplier Ledger
      <small>Manage Supplier Ledger</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="ledger_table" class="table table-custom spacing5 text-center">
                <thead>
                </thead>
                <tbody>
                </tbody>
  ...
  $(document).ready(function () {
    ...
    function load_ledger() {
      ...
      $.ajax({
        ...
        url: "includes/sup_ledger_module.php",
        type: "POST",
        data: { supplier_id: <?php echo $supplier_id; ?> },
        success: function (two) {
          console.log(two);

          //Fetch data in table//
          $("#ledger_table").html(two);
    ...
    function balance() {
      ...
      var c_balance = 0;
      var tr = $("#ledger_table > tbody > tr");
      tr.each(function () {
        var received = parseFloat($(this).find("#received").text());
        console.log(received);
        var paid = parseFloat($(this).find("#paid").text());
        console.log(paid);
        c_balance += paid - received;
        $(this).find("#balance").text(c_balance);
      });

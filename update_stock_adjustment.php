...
if(isset($_GET["stk_adjustment_id"])){
    $stock_id = $_GET["stk_adjustment_id"];

    $up_query = $con->prepare("SELECT * FROM stk_adjustment WHERE stk_adjustment_id=:stk_adjustment_id");
    $up_query->execute([
        "stk_adjustment_id"=>$stock_id
    ]);

    $row = $up_query->fetch(PDO::FETCH_ASSOC);

    $pur_data["os_date"] = $row["adj_date"];
    $pur_data["os_detail"] = $row["adj_detail"];
...
<div class="content-wrapper" style="padding-top:10px;">
    ...
    <section class="content-header">
        <h1>
            Stock Adjustment
            <small>Update Stock Adjustment</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Update Stock Adjustment</li>
        </ol>
    </section>
                        ...
                        <div class="box-body" style="padding-top:15px;">
                            ...
                            <div class="col-md-12" style="">
                                <table class="table text-center" id="pur_table">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = $con->prepare("SELECT * FROM all_stock LEFT JOIN products ON all_stock.product_id=products.pro_id WHERE stk_adj_id=:stk_adj_id");
                                            $query->execute([
                                                "stk_adj_id"=>$stock_id
                                            ]);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="qty[]" id="qty" value="<?php echo $data["stock_out_qty"];?>">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="total[]" id="total" value="<?php echo $data["total_stk_adj_price"];?>" readonly>
                                            </td>
                ...
                $.ajax({
                    ...
                    success: function (invoice) {
                        ...
                        if ($.trim(invoice) === 'stock_updated') {
                            Swal.fire({
                                title: "Success!",
                                text: "Stock Adj Invoice updated Successfully!",
                                type: "success",
                                customClass: "sweet-alert",
                            }).then(function () {
                                window.location="allstock_adjustment.php";
                            });
                        }

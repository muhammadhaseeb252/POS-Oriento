      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-aqua">
            ...
            <h4 class="modal-title">Insert New Owner:</h4>
          </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <label class="textboxlabel">Owner Name:</label>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-12">
        ...
        $.ajax({
          ...
          success: function (one) {
            ...
            if ($.trim(one) === "inserted") {
              toastr.success("Owner has been added successfuly!", "Successful!");
      ...
      $.ajax({
        ...
        success: function (two) {
          ...
          $("#customer_table").dataTable({
            ...
            buttons: [
              {
                text: '<i class="ion ion-person-add"></i>&nbsp; Add Owner',
    ...
    $(document).on("click", "#update_btn", function (e) {
      ...
      $.ajax({
        ...
        success: function (three) {
          ...
          $("#update").val(three["owner_id"]);
          $("#u_name").val(three["owner_name"]);
          $("#u_email").val(three["owner_email"]);
          $("#u_phone").val(three["owner_phone"]);
        ...
        $.ajax({
          ...
          success: function (four) {
            ...
            if ($.trim(four) === "updated") {
              toastr.info("Owner has been updated successfully!", "Successful!");
          ...
          $.ajax({
            ...
            success: function (five) {
              ...
              if ($.trim(five) === "deleted") {
                toastr.warning("Owner has been deleted successfully!", "Successful!");
                //refresh page//
                load_customer();
              }
